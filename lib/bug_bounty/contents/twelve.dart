...
class BountyTwelve extends StatefulWidget {
  @override
  _BountyTwelveState createState() => _BountyTwelveState();
}

class _BountyTwelveState extends State<BountyTwelve> {
  var text = '''
